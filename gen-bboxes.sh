...
shp2pgsql -D -s 27700 "${BLDATADIR}/Data/Supplementary_Historic_European_Region/historic_european_region_region.shp" euregions | psql -d codepointopen $PGCONNOPTS
